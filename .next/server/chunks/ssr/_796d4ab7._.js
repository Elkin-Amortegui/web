...
;
const metadata = {
    title: 'UniLlanos Language Hub',
    description: 'Centro de Idiomas de la Universidad de los Llanos. Cursos de inglés, francés, alemán y portugués.',
    keywords: "Cursos de idiomas en Villavicencio, Centro de Idiomas UNILLANOS, Aprende inglés en Meta, Unillanos idiomas, aprender frances, aprender aleman, aprender portugues"
};
