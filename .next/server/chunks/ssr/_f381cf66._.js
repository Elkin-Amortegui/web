...
"[project]/.next-internal/server/app/tramites/page/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const tramitesData = [
    {
        ...
        excerpt: 'Guía paso a paso para solicitar certificados de niveles cursados, constancias de estudio y otros documentos académicos oficiales del Centro de Idiomas.',
    ...
    },
    {
        ...
        date: '2024-02-01',
        category: 'Académico',
        excerpt: 'Información sobre el proceso para homologar niveles de idiomas cursados en otras instituciones o validar conocimientos previos mediante examen.',
      ...
      <h3 class="text-xl font-semibold text-primary mb-3">Proceso:</h3>
      <ol class="list-decimal list-inside space-y-2 mb-6">
        <li>Presenta la documentación requerida en la coordinación académica del Centro de Idiomas.</li>
        <li>Para validación, se programará un examen de clasificación.</li>
        <li>El comité académico revisará la solicitud y emitirá un concepto.</li>
        <li>Se te notificará el resultado y los pasos a seguir.</li>
      </ol>
    ...
    },
    {
        ...
        excerpt: 'Procedimiento y condiciones para solicitar cambios de horario o de grupo en los cursos de idiomas, sujeto a disponibilidad y aprobación.',
      ...
      <ul class="list-disc list-inside space-y-1 mb-4">
        <li>Solo se considerarán solicitudes por motivos de fuerza mayor debidamente justificados (calamidad doméstica, cruce de horarios con materias de carrera, etc.).</li>
        <li>La solicitud debe realizarse durante la primera semana de clases.</li>
        <li>Debe existir cupo disponible en el horario o grupo solicitado.</li>
      </ul>
      <h3 class="text-xl font-semibold text-primary mb-3">Procedimiento:</h3>
      <ol class="list-decimal list-inside space-y-2 mb-6">
        <li>Diligenciar el formato de solicitud de cambio, disponible en la secretaría.</li>
        <li>Adjuntar los soportes que justifiquen la solicitud.</li>
        <li>Radicar la solicitud en la coordinación del Centro de Idiomas.</li>
        <li>Esperar la respuesta, que será comunicada en un plazo máximo de 3 días hábiles.</li>
      </ol>
      <p class="text-muted-foreground">No se garantiza la aprobación de todas las solicitudes. La decisión final recae en la coordinación académica.</p>
    `
    }
];
}}),
"[project]/src/app/tramites/page.tsx [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tramites$2f$TramiteData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tramites/TramiteData.ts [app-rsc] (ecmascript)"); // Importar datos de trámites
;
;
;
;
...
function TramitesPage() {
    // TODO: Implement search and filter functionality for tramites
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tramites$2f$TramiteData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["tramitesData"].map((tramite)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Card"], {
...
"[project]/src/app/tramites/page.tsx [app-rsc] (ecmascript, Next.js server component)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/tramites/page.tsx [app-rsc] (ecmascript)"));
}}),

};

//# sourceMappingURL=_f381cf66._.js.map