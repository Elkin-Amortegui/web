(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ba4f574d._.js", {
...
function NewsPage() {
    ...
    const [filteredArticles, setFilteredArticles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$noticias$2f$NewsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["articles"]);
    const availableYears = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewsPage.useMemo[availableYears]": ()=>{
            const years = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$noticias$2f$NewsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["articles"].map({
                "NewsPage.useMemo[availableYears]": (article)=>new Date(article.date).getFullYear().toString()
            }["NewsPage.useMemo[availableYears]"]));
            return [
                'all',
                ...Array.from(years).sort({
                    "NewsPage.useMemo[availableYears]": (a, b)=>parseInt(b) - parseInt(a)
                }["NewsPage.useMemo[availableYears]"])
            ];
        }
    }["NewsPage.useMemo[availableYears]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewsPage.useEffect": ()=>{
            let tempArticles = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$noticias$2f$NewsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["articles"];
            // Filter by search term
            if (searchTerm) {
                tempArticles = tempArticles.filter({
                    "NewsPage.useEffect": (article)=>article.title.toLowerCase().includes(searchTerm.toLowerCase()) || article.excerpt.toLowerCase().includes(searchTerm.toLowerCase()) || article.content && article.content.toLowerCase().includes(searchTerm.toLowerCase())
                }["NewsPage.useEffect"]);
            }
            // Filter by year
            if (selectedYear !== 'all') {
                tempArticles = tempArticles.filter({
                    "NewsPage.useEffect": (article)=>new Date(article.date).getFullYear().toString() === selectedYear
                }["NewsPage.useEffect"]);
            }
            // Filter by semester
            if (selectedSemester !== 'all') {
                tempArticles = tempArticles.filter({
                    "NewsPage.useEffect": (article)=>{
            ...
            tempArticles.sort({
                "NewsPage.useEffect": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["NewsPage.useEffect"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Mantente informado sobre las últimas actividades, convocatorias y logros del Centro de Idiomas UNILLANOS."
                    }, void 0, false, {
                        fileName: "[project]/src/app/noticias/page.tsx",
                        lineNumber: 70,
                        columnNumber: 9
...
_s(NewsPage, "kK8uP968ShkTmvgPrqdCDk4jpY4=");
_c = NewsPage;
var _c;
...
//# sourceMappingURL=src_ba4f574d._.js.map