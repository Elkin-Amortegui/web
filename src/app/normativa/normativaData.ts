...
export interface NormativaItem {
  ...
  pdfPath?: string; // Path inside /public folder. E.g., '/docs/normativa/resolucion-0659.pdf'
...
export const normativaData: NormativaItem[] = [
  {
    ...
    category: "Resolución",
    icon: FileText,
    pdfPath: '#' // Placeholder: Replace with actual path e.g., '/docs/normativa/res-0659.pdf'
  },
  {
    id: 'res-2337-2023',
  ...
  },
  {
    ...
    icon: FileClock,
    isGroup: true,
    pdfPath: '#', // Placeholder for a combined PDF or link to the most relevant one
    subItems: [
